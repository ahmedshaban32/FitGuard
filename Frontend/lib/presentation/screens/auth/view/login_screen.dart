// lib/presentation/screens/auth/view/login_screen.dart
//
// CHANGE from original: added "Forgot Password?" TextButton below the
// password field (line ~140). Everything else is identical.
...
import 'package:fit_guard_app/presentation/screens/auth/view/forgot_password_screen.dart'; // ← NEW
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // PASSWORD LABEL + FORGOT LINK (row) ← NEW
                Row(
